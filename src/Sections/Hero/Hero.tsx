...
const Hero: React.FC = () => {
  ...
  <SyledBackground theme={theme}>
    <Container>
      <div>
        <img style={{width:"333px", borderRadius: "64px", boxShadow: `-4px -4px ${theme.shadow}`}} src={avatar}/>
      ...
      <div>
        <Header>Luã de Freitas Ramos</Header>
        <h6 style={{fontSize: "2rem"}}>{t("hero.subtitle")}</h6>
        <p style={{ padding: "0.6rem 0"}}>{t("hero.description")}</p>
